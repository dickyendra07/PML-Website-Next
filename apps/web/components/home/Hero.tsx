...
const slides = [
  {
    ...
    description:
      "Pharma Metric Labs supports pharmaceutical, biotechnology, medical device, food, beverage, and healthcare companies with integrated CRO services, from BA/BE studies and clinical trials to contract analysis and regulatory consultation.",
  ...
  },
  {
    ...
    description:
      "PML supports BA/BE studies from clinical conduct and bioanalysis to regulatory-ready reporting, helping sponsors move forward with quality, compliance, and confidence.",
    primary: "Request a Proposal",
    secondary: "Explore BA/BE Services",
    secondaryHref: "#services",
  ...
  },
  {
    ...
    primary: "Request a Proposal",
    secondary: "Explore Clinical Services",
    secondaryHref: "#services",
