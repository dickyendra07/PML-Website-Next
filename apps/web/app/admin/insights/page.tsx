        ...
        <div className="grid gap-6">
          ...
          >
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <label className="grid gap-2 md:col-span-2">
                <span className="text-sm font-black text-black">Excerpt / FAQ Answer Preview</span>
                <textarea
                  rows={4}
                  value={form.excerpt}
              ...
              <label className="grid gap-2">
                <span className="text-sm font-black text-black">Tags</span>
                <input
                  value={form.tags}
              ...
              <label className="flex items-center gap-3 rounded-2xl border border-black/5 bg-white5 px-4 py-3">
                ...
                />
                <span className="text-sm font-black text-black">Featured Insight</span>
              </label>
            </div>
