        ...
        <div className="pml-container relative flex min-h-[calc(100vh-80px)] flex-col justify-center py-16 md:py-24">
          ...
          <div className="max-w-4xl">
            ...
            <p className="mt-6 max-w-2xl text-[17px] leading-8 text-black/70 md:text-[19px] md:leading-9 md:text-lg">
              PML supports pharmaceutical, biotechnology, food and beverage, and
              cosmetic companies with contract analysis services for product
              quality, safety, and regulatory compliance needs.
            </p>
        ...
        <div className="pml-container">
          <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr]">
            ...
            <div className="space-y-5 text-[17px] leading-8 text-black/68 md:text-[19px] md:leading-9">
              <p>
                PML provides contract analysis services for companies that need
                reliable laboratory testing support for product quality, safety,
                and compliance needs. The service is designed for
                pharmaceutical, biotechnology, food and beverage, and cosmetic
                product requirements.
              </p>

              <p>
                From sample receiving and testing requirement review to
                analytical execution and report documentation, PML helps clients
                move from testing inquiry to clear laboratory results with
        ...
        <div className="pml-container">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-[17px] leading-8 text-black/68 md:text-[19px] md:leading-9 md:text-lg">
              PML supports selected analytical, microbiology, sample handling,
              documentation, and urgent analysis needs through a structured
              laboratory workflow.
            </p>
          </div>
                  ...
                  <div>
                    ...
                    {group.featured && (
                      <p className="mt-4 max-w-xl text-base font-semibold leading-8 text-black/58">
                        Dedicated analytical development support for method
                        readiness, verification, validation, dissolution
                        comparison, stability storage, and method transfer.
                      </p>
                    )}
                  </div>
        ...
        <div className="pml-container">
          <div className="max-w-4xl">
            ...
            <p className="mx-auto mt-6 max-w-3xl text-[17px] leading-8 text-black/68 md:text-[19px] md:leading-9 md:text-lg">
              Contract Analysis services are relevant for companies that need
              product quality, safety, compliance, or laboratory testing support
      ...
      <section className="relative overflow-hidden bg-[#f4fbf7] px-4 py-20 text-black md:py-28">
        ...
        <div className="pml-container relative">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-4 text-4xl font-black leading-tight text-black md:text-[52px]">
              Analytical support backed by laboratory capability and structured
              reporting
            </h2>

            <p className="mt-6 text-[17px] leading-8 text-black/70 md:text-[19px] md:leading-9">
              PML supports clients with analytical testing workflows designed to
              help evaluate product quality, safety, documentation, and
        ...
        <div className="pml-container">
          <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr]">
            <div>
              ...
              <p className="mt-6 text-[17px] leading-8 text-black/68 md:text-[19px] md:leading-9 md:text-lg">
                To prepare accurate testing support, clients can share sample,
                parameter, timeline, and method-related information before
          ...
          <div className="relative overflow-hidden rounded-[36px] bg-[#f4fbf7] px-8 py-16 text-center text-black shadow-[0_28px_90px_rgba(0,0,0,0.12)] md:px-14 md:py-20">
            ...
            <div className="relative mx-auto max-w-3xl">
              ...
              <p className="mx-auto mt-5 max-w-2xl text-[17px] leading-8 text-black/70 md:text-[19px] md:leading-9">
                Share your sample and testing requirements with our team and we
